...
historia = """\nO Reino de Libertália era um símbolo de equilíbrio e poder, onde magos e guerreiros viviam em paz, protegendo suas terras sob a liderança justa do Império Libertália — uma cidade majestosa localizada no centro do reino.
...
while escolha not in[1,2]:
    ...
    escolha = int(input("Digite '1' ou '2' para escolher seu herói: "))
    limparTELA()
if escolha == 1:
...
while local not in[1,2,3]:
    ...
    local  = int(input("Digite '1' para ir ao Canyon Cozz, digite '2' se deseja que seu destino seja o Vilarejo destruído de Ludwig ou digite '3' se deseja ir ao reino destruído...Leve em consideração que a probabilidade de vitória é muito pequena: "))
...
if local == 1:
        ...
        print ("Você achou ao canyon, um lugar onde o silêncio domina e o misterio reina...\n")
        input("Pressione ENTER para continuar")
        
        limparTELA()
        
        print("Começa a percebr uma movimentação estranha, e o silêncio que estava presentre a todo momento desaparece...\n")
        print("FWWWWIP-TCHK", "uma Shuriken vem voando em sua direção e quase o atinge.")
        input("Pressione ENTER para continuar")
        
        limparTELA()
        
        print("Você se esconde atrás de uma pedra e onserve quem está aproximando... A silhueta do ser vai tomando forma a cada passo que ele da, e de repente você percebe que stá diante de um Ninja do Canyon, um protetor das terras silencosas.")
        print("Você precisa tomar uma decisão rapidamente.") 
        input("Pressione ENTER para")
        
        limparTELA()
        
        escolha2 = int(input("Aperte 1 para lutar, ou aperte 2 para fugir:"))
        if escolha2 == 1:
                print("A batalha começa e você está com o ", Mago())
                Mago()
        elif escolha2 == 2:
                print("A batalha começa e você está com o ", guerreiro())
                guerreiro()        
